...
//********************
//* Opens print window for instructions
//********************
function open_prn_win(url)
{
	NewWindow=window.open(url,'_PW','toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbar=yes,scrollbars=yes,resizable=yes,copyhistory=no,width=500,height=500');
}
