 ...
 * @author
 */
public class WSServletRaw extends HttpServlet implements ICommandFactory, ISecurityHandler
{
	private static final Logger LOGGER = Logger.getLogger(WSServletRaw.class);
	...
	public void init(ServletConfig arg0) throws ServletException 
	{
		...
		try
		{
			...
			InputStream is = getClass().getResourceAsStream("/connective/teamup/download/wsconfig_raw.xml");
			commands = ws.init(is);
	...
	*/
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		TeamupMessage msgOut = ws.processRequestRaw(msgIn);
		
		String outXML = msgOut.getData();
