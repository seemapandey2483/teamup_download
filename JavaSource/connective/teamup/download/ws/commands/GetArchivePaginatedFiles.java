...
public class GetArchivePaginatedFiles implements ICommand{
	...
	public Object perform(Object inputData, SecurityStatus secInfo) throws Exception {
		...
		try{
			...
			downloadFileInfos = archiveService.getArchiveFilesSelected(databaseOperation, secInfo.getAgentId(), pageNo, rowsPerSelected, true);
		} finally {
