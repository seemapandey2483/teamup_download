...
public class GetCurrentSearchPaginatedFiles implements ICommand{
	...
	public Object perform(Object inputData, SecurityStatus secInfo)
		...
		try{
			...
			downloadFileInfos = archiveService.getCurrentSearchFiles(databaseOperation, secInfo.getAgentId(), pageNo, rowsPerSelected, true, searchString,searchFor);
		} finally {
