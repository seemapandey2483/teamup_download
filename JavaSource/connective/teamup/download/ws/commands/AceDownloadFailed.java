...
import connective.teamup.download.ws.objects.AceDownloadFailedInput;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class AceDownloadFailed implements ICommand 
{
	/* (non-Javadoc)
	...
	{
		AceDownloadFailedInput input = (AceDownloadFailedInput) inputData;
		...
		try
		{
			...
			service.downloadFailed(op, null, agent, input.getBatchNumber(), input.getErrorMsg(),
				input.getStackTrace());
		}
		finally
		{
