...
public class GetArchiveSearchFileCount implements ICommand {
	...
	public Object perform(Object inputData, SecurityStatus secInfo)
		...
		try{
			...
			fileCount = archiveService.getArchivesearchFileCount(op,secInfo.getAgentId(), searchString, searchFor);
		} finally{
			if(op!=null)
				op.close();
		}
