 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class GetAgentsForLogin implements ICommand 
{
	private static final Logger LOGGER = Logger.getLogger(GetAgentsForLogin.class);
	
	protected SecurityProvider securityProvider = null;
	
	public GetAgentsForLogin()
	{
		try
		{
	...
	public Object perform(Object inputData, SecurityStatus secInfo) throws Exception 
	{
		...
		String[] ret = securityProvider.getAgentsForLogin(input.getLoginId(), input.getPassword());
		return ret;
	}
}
