...
import connective.teamup.download.ws.objects.GetAgentReportsInput;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class GetAgentReports2 implements ICommand {
	...
	{
		GetAgentReportsInput input = (GetAgentReportsInput) inputData;
		GetAgentReportsOutput output = null;
		
		String path = "/agency";
		String agentId = secInfo.getAgentId();
		StringBuffer agentKey = new StringBuffer(input.getSecurityKey());  
