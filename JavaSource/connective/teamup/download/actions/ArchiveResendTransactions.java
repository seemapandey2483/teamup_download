 ...
 * then navigate to the download control page to download files tagged for "resend."
 */
public class ArchiveResendTransactions extends UpdateArchiveFiles
{

	/**
	 * Constructor for ArchiveHideTransactions.
	 */
	public ArchiveResendTransactions()
	{
		super();
	}
