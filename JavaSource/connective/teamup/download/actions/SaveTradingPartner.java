 ...
 */
public class SaveTradingPartner implements Action
{
	private static final Logger LOGGER = Logger.getLogger(SaveTradingPartner.class);
	/**
	 * Constructor for SaveTradingPartner.
	 */
	public SaveTradingPartner()
	{
		super();
	}
	...
	public String perform(HttpServletRequest req, HttpServletResponse resp, ServerInfo serverInfo, DatabaseOperation op, FileItem[] items) throws ActionException
	{
		...
		try
		{
			...
			agent.setName(req.getParameter("agencyname"));
			agent.setAmsVer(req.getParameter("version"));
			...
			String dlDir = req.getParameter("dldir");
			if (dlDir == null)
				dlDir = "";
			...
			String resetFlag = req.getParameter("reset_agent_to_nonreg");
			...
			if (!newAgent)
			{
				...
				String updateFlag = req.getParameter("updtAmsSettings");
			...
			String sendEmail = req.getParameter("send_email");
			if (sendEmail != null && sendEmail.equals("Y"))
			{
		...
		{
			LOGGER.error("Error saving agent configuration", e);
