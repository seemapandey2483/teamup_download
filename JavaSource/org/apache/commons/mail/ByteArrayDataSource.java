 ...
 * @version $Id: ByteArrayDataSource.java,v 1.1 2007/01/03 22:15:29 mike Exp $
 */
public class ByteArrayDataSource implements DataSource
{
	private static final Logger LOGGER = Logger.getLogger(ByteArrayDataSource.class);
    ...
    public ByteArrayDataSource(String data, String aType) throws IOException
    {
        ...
        {
        	LOGGER.error("The Character Encoding is not supported."+ uex);
